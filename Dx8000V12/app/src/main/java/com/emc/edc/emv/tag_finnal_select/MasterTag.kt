...
fun MasterTag(
    ...
    try {
        ...
        if (tagAidData.contactless_transactionlimit != "") {
            tlvList.append(
                EMVTag.M_TAG_TM_TRANS_LIMIT + (tagAidData.contactless_transactionlimit!!.length / 2).toString()
        ...
        if (tagAidData.contactless_floorlimit != "") {
            tlvList.append(
                EMVTag.M_TAG_TM_FLOOR_LIMIT + (tagAidData.contactless_floorlimit!!.length / 2).toString()
        ...
        if (tagAidData.contacless_cvmlimit != "") {
            tlvList.append(
                EMVTag.M_TAG_TM_CVM_LIMIT + (tagAidData.contacless_cvmlimit!!.length / 2).toString()
